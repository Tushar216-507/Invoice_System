...
CREATE TABLE IF NOT EXISTS purchase_orders (
  ...
  created_by INT NULL,
  esign_requested BOOLEAN NOT NULL DEFAULT FALSE,
  esign_status ENUM('pending', 'approved', 'rejected', 'not_requested') NOT NULL DEFAULT 'not_requested',
  esign_requested_at DATETIME NULL,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
